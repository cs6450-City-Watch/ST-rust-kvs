...
def main():
    if len(sys.argv) != 5:
        print("Usage: python workload_gen.py <output_file> <num_transactions> <ops_per_transaction> <get_proportion>")
        print("Example: python workload_gen.py txns.txt 10 3 0.7")
        sys.exit(1)
